@extends('layouts.app')
@section('title', 'Data Kelas, Siswa, dan Guru')

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h1 class="card-title fs-4">Data Kelas, Siswa, dan Guru</h1>
        </div>
        <div class="card-body">
            <div class="card card-p-0 card-flush">
                <div class="card-body p-2">
                    <table class="table align-middle border rounded table-sm fs-7" id="kelas_siswa_guru_table">
                        <thead>
                            <tr class="text-start text-gray-500 fw-bold text-uppercase">
                                ...
                                <th class="px-2 text-start">Daftar Siswa</th>
                            </tr>
                        </thead>
...
@section('page_script')
    <script>
        $(document).ready(function() {
            $('#kelas_siswa_guru_table').DataTable({
                responsive: true,
                autoWidth: false,
                language: {
                    search: "Cari:",
