            ...
            <form method="POST" action="{{ route('kelas.store') }}">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control" id="nama_kelas" name="nama_kelas"
                        value="{{ old('nama_kelas') }}" required placeholder="Enter class name...">
                    @error('nama_kelas')
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Enter class description...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
